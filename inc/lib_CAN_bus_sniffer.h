...
#define NUM_CAN_SNIFF 25
    ...
    #if defined(SNIFF_CRUISE_CONTROL_DIST_PLUS_BUTTON_SUPPORTED) || !defined(LIMIT_PIDS)
    #define SNIFF_CRUISE_CONTROL_DIST_PLUS_BUTTON_PID SNIFF_CRUISE_CONTROL_DIST_PLUS_BUTTON
    #define SNIFF_CRUISE_CONTROL_DIST_PLUS_BUTTON_ID 0x030
    #endif

    #if defined(SNIFF_CRUISE_CONTROL_DIST_MINUS_BUTTON_SUPPORTED) || !defined(LIMIT_PIDS)
    #define SNIFF_CRUISE_CONTROL_DIST_MINUS_BUTTON_PID SNIFF_CRUISE_CONTROL_DIST_MINUS_BUTTON
    #define SNIFF_CRUISE_CONTROL_DIST_MINUS_BUTTON_ID 0x030
    #endif

    #if defined(SNIFF_CRUISE_CONTROL_RES_PLUS_BUTTON_SUPPORTED) || !defined(LIMIT_PIDS)
    #define SNIFF_CRUISE_CONTROL_RES_PLUS_BUTTON_PID SNIFF_CRUISE_CONTROL_RES_PLUS_BUTTON
    #define SNIFF_CRUISE_CONTROL_RES_PLUS_BUTTON_ID 0x030
    #endif

    #if defined(SNIFF_ESC_SPORT_MODE_BUTTON_SUPPORTED) || !defined(LIMIT_PIDS)
    #define SNIFF_ESC_SPORT_MODE_BUTTON_PID SNIFF_ESC_SPORT_MODE_BUTTON
    #define SNIFF_ESC_SPORT_MODE_BUTTON_ID 0x1C0
    #endif

    #if defined(SNIFF_ESC_OFF_MODE_BUTTON_SUPPORTED) || !defined(LIMIT_PIDS)
    #define SNIFF_ESC_OFF_MODE_BUTTON_PID SNIFF_ESC_OFF_MODE_BUTTON
    #define SNIFF_ESC_OFF_MODE_BUTTON_ID 0x1C0
    #endif
